    ...
    <div class="container-fluid">
        ...
        <div id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                --}}
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="{{ asset(auth()->user()->profile ? auth()->user()->profile->image()->first()->smallImage : 'admin/img/default-user-image.png') }}" class="img-circle" alt="Avatar"> <span>{{ Auth::user()->name }}</span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
